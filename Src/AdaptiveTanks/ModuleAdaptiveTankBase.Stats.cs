...
public partial class ModuleAdaptiveTankBase : IPartCostModifier, IPartMassModifier
{
    ...
    {
        volumeL = stacks!.Core.EvaluateTankVolume() * MathUtils.M3toL;
    ...
    public float GetStructuralCost() => stacks!.Skin.EvaluateStructuralCost();
    public float GetStructuralMass() => stacks!.Skin.EvaluateStructuralMass();
}